...
public class Generation {
    ...
    public static Registration generateNewValidActiveUser() {
    ...
    public static Registration generateNewValidBlockedUser() {
        Faker faker = new Faker(new Locale("eng"));
        String login = faker.name().firstName().toLowerCase();
        String password = faker.internet().password();
    ...
    public static Registration generateNewUserWithInvalidLogin() {
        ...
        makeRegistration(new Registration("diana", password, status));
        return new Registration("chris", password, status);
    }
